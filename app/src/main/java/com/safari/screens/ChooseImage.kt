...
@Composable
fun ChooseImage(modifier: Modifier = Modifier, shopItemsViewModel: ShopItemsViewModel) {

    val context = LocalContext.current

    val uploadStatus = shopItemsViewModel.uploadTask.value
    ...
    Box(modifier = modifier.fillMaxSize()) {
        Column(
            ...
            LaunchedEffect(key1 = uploadStatus.isSuccess) {
                scope.launch {
        ...
        OutlinedButton(
            onClick = {
                ...
                shopItemsViewModel.addItemToDatabase(item)
